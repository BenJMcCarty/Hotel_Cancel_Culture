...
def adf_test(ts, p = .05):
    ...
    Args:
        ts ([type]): [description]
        p (float, optional): [description]. Defaults to .05.
...
def remove_trends(timeseries, method, window = 4, figsize=(10,5)):
    ...
    Args:
        ...
        window (int, optional): [description]. Defaults to 4.
...
def plot_acf_pacf(data, lags=52, suptitle=None, figsize = (10,5)):
    ...
    Adapted from: https://github.com/flatiron-school/Online-DS-FT-022221-Cohort-Notes/blob/master/Phase_4/topic_38_time_series_models/topic_38-time_series_models_v3_SG.ipynb

    Args:
        data ([type]): [description]
        lags (int, optional): [description]. Defaults to 52.
        suptitle ([type], optional): [description]. Defaults to None.
        figsize (tuple, optional): [description]. Defaults to (10,5).
...
def train_test_split(data, split_point, xlabel, ylabel, title,
                     figsize = (10,5), show_vis = True, **kwargs):
    ...
    Args:
        ...
        **kwargs: Accepts additional keyword arguments if needed.
...
def create_best_model(timeseries_dataset, m, 
    ...
    """Calculates best model parameters via auto-arima, then fits a new SARIMAX model for results.
    ...
    Returns:
        auto_model, best_model: auto_arima-generated model with best parameters, SARIMAX model using best parameters.
    """
...
def ts_modeling_workflow(data, threshold, m, xlabel, ylabel, title, figsize = (10,5), alpha=0.05, show_vis = True):
    ...
    Args:
        ...
        show_vis (bool, optional): [description]. Defaults to True.
